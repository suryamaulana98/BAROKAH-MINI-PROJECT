    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('pembimbing.pengumpulanjurnal') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pengumpulan jurnal
                        </li>
                    </ol>
                    <h6 class="font-weight-bolder tex t-white mb-0" style="color: #fff;">Pengumpulan jurnal</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <p style="font-size: 24px; font-weight: bold;">Pengumpulan Jurnal<input type="search"
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 px-3">Femas akbar faturrohim
                                                </p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="">
                                                <p class="text-xs font-weight-bold mb-0">23 Mei 2023</p>
                                            </td>
                                            <td>
                                                <span class="badge badge-sm bg-success"
                                                    style="width: 80px;">SUDAH</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
